const febHolidays = [
    ...
    "Maine shiddat se chaha hai tumhe, I love the way u are❤️",
    "You're my everything ✔",
    "You are my soulmate(kidding) ✨💕",
    "And of course... wait .....",
    " my friend 🤭",
    "I will always be there for you",
    "No matter how far we are🥰",
    "I promise I will never multi-thread on you",
    "You're the prettiest, cutest, mature,",
    "sweetest girl alive. 🤞✍",
    ...
    "but i konw one thing ",
    "us din ke baad se tum meri sabsi acchi dost ho ",
  ];
